...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # --- Correction Model Dropdown + Search + Refresh ---
        ...
        input_layout.addWidget(QLabel("Summarization Model:"), 5, 0)
        ...
        input_layout.addWidget(QLabel("Output Path:"), 6, 0)
